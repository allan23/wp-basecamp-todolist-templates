                ...
                <div class="bct_innerbox">
                    <div class="bct_content">
                        ...
                        <p><strong>Enter the following redirect URL:</strong><br><br>
                            <em><?php menu_page_url("todolist", true); ?></em></p>
                ...
                <div class="bct_innerbox">
                    <div class="bct_content">
                        ...
                        <form method="post" action="options.php">
                            ...
                            <input type="text" name="BC_ClientID" value="<?php echo $client_id; ?>"><br><br>
                            <label>Client Secret:</label><br>
                            <input type="text" name="BC_Secret" value="<?php echo $client_secret; ?>"><br><br>
